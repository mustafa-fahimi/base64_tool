...
part of 'main_modules_providers.dart';
...
final appHelperProvider = Provider<AppHelper>.internal(
  appHelper,
  name: r'appHelperProvider',
  debugGetCreateSourceHash:
      const bool.fromEnvironment('dart.vm.product') ? null : _$appHelperHash,
  dependencies: null,
  allTransitiveDependencies: null,
);
