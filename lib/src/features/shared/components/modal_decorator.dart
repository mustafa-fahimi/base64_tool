...
class ModalDecorator extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final maxWidth = context.responsive.smallerOrEqualTo(TABLET)
        ? context.deviceWidthFactor(1)
        : isWideOnDesktop
            ? context.deviceWidthFactor(0.75)
            : context.deviceWidthFactor(0.45);
    ...
    return PopScope(
      onPopInvoked: (_) => onPopInvoked(context, ref),
...
class _SecondaryButtonWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final width = context.responsive.smallerOrEqualTo(TABLET)
    ...
    return OutlinedButtonComponent(
      ...
      onTap: secondaryButtonOnTap ?? () => context.router.popForced(),
    );
  }
}
...
class _TitleWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      width: context.deviceWidthFactor(0.75),
      child: Text(
        title!,
